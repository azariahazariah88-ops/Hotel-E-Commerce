  ...
  const handlePay = async () => {
    ...
    try {
      ...
      const options = {
        ...
        image:       '',                  // add your logo URL here if you want
        ...
        notes: {
          address: 'Hungry Layer Restaurant'
        },
        ...
        // Step 4 — on success verify with backend
  ...
  if (success) {
    return (
      <div style={{
        ...
        fontFamily: "'Lora', serif", gap: 24, padding: 20,
      }}>
        <style>{`
        ...
        <div style={{ textAlign: 'center', animation: 'fadeUp 0.5s ease 0.2s both' }}>
          ...
          <p style={{ color: '#4caf50', margin: '10px 0 4px', fontWeight: 700, fontSize: '1.2rem' }}>
        ...
        <button
          ...
          style={{
            ...
            padding: '14px 44px', fontWeight: 700,
      ...
      <div style={{ padding: '56px 0 80px', display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: 460, padding: '0 20px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 36 }}>
            ...
            <p style={{ color: '#555', marginTop: 8, fontSize: '0.88rem' }}>
          ...
          <div style={{
            ...
            <p style={{ color: '#444', fontSize: '0.76rem', textTransform: 'uppercase', letterSpacing: 1.5, margin: '0 0 16px' }}>
          ...
          <button
            ...
            style={{
              ...
              color: '#111', border: 'none', borderRadius: 32,
              padding: '16px', fontWeight: 700, fontSize: '1.08rem',
              cursor: loading ? 'not-allowed' : 'pointer',
              fontFamily: "'Lora', serif",
              boxShadow: loading ? 'none' : '0 6px 28px rgba(245,200,66,0.35)',
